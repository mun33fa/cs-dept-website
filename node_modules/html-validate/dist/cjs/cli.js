...
async function getBaseConfig(preset, filename) {
  if (filename) {
    const configData = await resolver.resolveConfig(path__default$1.default.resolve(filename), { cache: false });
    if (!configData) {
